...
function playAmbience() {
  ...
  if (!soundEnabled) return;
  const melody = () => chirp([523.25, 659.25, 783.99, 659.25, 587.33, 783.99], 'sine', 0.22, 0.018);
  melody();
  ambienceTimer = setInterval(melody, 4200);
}

function stopAmbience() { clearInterval(ambienceTimer); }
